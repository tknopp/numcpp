...
NUMCPP_EXTERN_BUILD template Array< std::complex<float>, 2 >& fft_(Array< std::complex<float>, 2 >& x, int dir);
NUMCPP_EXTERN_BUILD template Array< std::complex<float>, 3 >& fft_(Array< std::complex<float>, 3 >& x, int dir);
NUMCPP_EXTERN_BUILD template Array< std::complex<double>, 1 >& fft_(Array< std::complex<double>, 1 >& x, int dir);
NUMCPP_EXTERN_BUILD template Array< std::complex<double>, 2 >& fft_(Array< std::complex<double>, 2 >& x, int dir);
NUMCPP_EXTERN_BUILD template Array< std::complex<double>, 3 >& fft_(Array< std::complex<double>, 3 >& x, int dir);

NUMCPP_EXTERN_BUILD template Array< std::complex<float>, 1 >& ifft_(Array< std::complex<float>, 1 >& x, int dir);
NUMCPP_EXTERN_BUILD template Array< std::complex<float>, 2 >& ifft_(Array< std::complex<float>, 2 >& x, int dir);
NUMCPP_EXTERN_BUILD template Array< std::complex<float>, 3 >& ifft_(Array< std::complex<float>, 3 >& x, int dir);
NUMCPP_EXTERN_BUILD template Array< std::complex<double>, 1 >& ifft_(Array< std::complex<double>, 1 >& x, int dir);
NUMCPP_EXTERN_BUILD template Array< std::complex<double>, 2 >& ifft_(Array< std::complex<double>, 2 >& x, int dir);
NUMCPP_EXTERN_BUILD template Array< std::complex<double>, 3 >& ifft_(Array< std::complex<double>, 3 >& x, int dir);
